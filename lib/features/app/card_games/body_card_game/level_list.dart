...
class BodyCardGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<BodyCardGameLevelList> createState() =>
      _BodyCorrectGameLevelListState();
}

class _BodyCorrectGameLevelListState
    extends ConsumerState<BodyCardGameLevelList> {
  @override
                  ...
                  return InkWell(
                    onTap: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const BodyCardGame(),
                      ));
                    },
                    child: Container(
