...
class OppositeCardGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OppositeCardGameLevelList> createState() => _OppositeCardGameLevelListState();
}

class _OppositeCardGameLevelListState extends ConsumerState<OppositeCardGameLevelList> {
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const OppositeCardGame(),));
                    },
                    child: Container(
                      ...
                      child: Center(
                        child: Text(twoNames[index], style: GoogleFonts.comfortaa(
                          textStyle:  const TextStyle(
