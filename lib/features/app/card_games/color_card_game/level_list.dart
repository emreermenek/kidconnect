...
class ColorCardGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ColorCardGameLevelList> createState() =>
      _ColorCardGameLevelListState();
}

class _ColorCardGameLevelListState
    extends ConsumerState<ColorCardGameLevelList> {
  List colorNavigation = [
    const YellowCardGame(),
    const RedCardGame(),
    const BlueCardGame(),
    const GreenCardGame(),
    const OrangeCardGame(),
    const PurpleCardGame(),
    const BrownCardGame(),
    const PinkCardGame(),
    const BlackCardGame()
  ];
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => colorNavigation[index],
                      ));
                    },
                    child: Container(
