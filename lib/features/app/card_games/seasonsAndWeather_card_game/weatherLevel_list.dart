...
class WeatherCardGameLevelList extends ConsumerStatefulWidget {
  const WeatherCardGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<WeatherCardGameLevelList> createState() => _WeatherCardGameLevelListState();
}

class _WeatherCardGameLevelListState extends ConsumerState<WeatherCardGameLevelList> {
          ...
          children: [
            Expanded(
              child: GridView.builder(
                ...
                itemCount: weatherNames.length,
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: () {
                      setState(() {
                        data.currentWeather = index;
                      });
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const WeatherCardGame(),));
                    },
                    child: Container(
