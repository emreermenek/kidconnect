...
class NutritionCardGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NutritionCardGameLevelList> createState() =>
      _NutritionAndWeatherCardGameLevelListState();
}

class _NutritionAndWeatherCardGameLevelListState
    extends ConsumerState<NutritionCardGameLevelList> {
  @override
              ...
              child: GridView(
                ...
                children: [
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) =>
                            const VegetablesCardGameLevelList(),
                      ));
                    },
                    child: Container(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const FruitsCardGameLevelList(),
                      ));
                    },
                    child: Container(
                      margin: const EdgeInsets.symmetric(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const FoodsCardGameLevelList(),
                      ));
                    },
                    child: Container(
                      margin: const EdgeInsets.symmetric(
