...
import 'package:bootcamp_f32/features/app/card_games/nutrition_card_game/nutrition_card_games/foods_card_game.dart';
...
class VegetablesCardGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VegetablesCardGameLevelList> createState() => _VegetablesCardGameLevelListState();
}

class _VegetablesCardGameLevelListState extends ConsumerState<VegetablesCardGameLevelList> {
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const VegetablesCardGame(),));
                    },
                    child: Container(
                      ...
                      child: Center(
                        child: Text(vegetableNames[index], style: GoogleFonts.comfortaa(
                          textStyle:  const TextStyle(
