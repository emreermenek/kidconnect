...
class FruitsCardGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FruitsCardGameLevelList> createState() => _FruitsCardGameLevelListState();
}

class _FruitsCardGameLevelListState extends ConsumerState<FruitsCardGameLevelList> {
                ...
                itemBuilder: (BuildContext context, int index) {
                  return InkWell(
                    onTap: () {
                      ...
                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const FruitCardGame(),));
                    },
                    child: Container(
                      ...
                      child: Center(
                        child: Text(fruitNames[index], style: GoogleFonts.comfortaa(
                          textStyle:  const TextStyle(
