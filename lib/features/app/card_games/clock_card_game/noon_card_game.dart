...
class NoonCardGame extends ConsumerStatefulWidget {
  const NoonCardGame({super.key});

  @override
  ConsumerState<NoonCardGame> createState() => _NoonCardGameState();
}

class _NoonCardGameState extends ConsumerState<NoonCardGame> {
  int hour = Random().nextInt(6) + 11;
  int minute = 0;
  List<int> hourList = List.generate(6, (index) => index + 11);
        ...
        body: Container(
          ...
          child: SingleChildScrollView(
            child: ValueListenableBuilder(
                ...
                {
                  hourList = List.generate(6, (index) => index + 11);
