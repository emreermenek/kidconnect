...
class NightCardGame extends ConsumerStatefulWidget {
  const NightCardGame({super.key});

  @override
  ConsumerState<NightCardGame> createState() => _NightCardGameState();
}

class _NightCardGameState extends ConsumerState<NightCardGame> {

  int minute = 0;
  int a = 0;
  int? hour;
  List<int> hourList = List.generate(3, (index) => index + 22) + List.generate(5, (index) => index + 1);
        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage('assets/images/card_games/clock_card_game_image/gece.png'),
                fit: BoxFit.fill
            ),
          ),
            ...
            child: ValueListenableBuilder(
                ...
                builder: (BuildContext context, value, Widget? child)
                {
                  ...
                  if(data.currentTime == 0){
                    ...
                    hour = hourList[Random().nextInt(7)];
                  }
                  return Column(
                    children: [
                      Padding(
