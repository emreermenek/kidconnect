...
class EveningCardGame extends ConsumerStatefulWidget {
  const EveningCardGame({super.key});

  @override
  ConsumerState<EveningCardGame> createState() => _EveningCardGameState();
}

class _EveningCardGameState extends ConsumerState<EveningCardGame> {
  int hour = Random().nextInt(6) + 16;
  int minute = 0;
  List<int> hourList = List.generate(5, (index) => index + 17);
        ...
        body: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
                image: AssetImage('assets/images/card_games/clock_card_game_image/aksam.png'),
                fit: BoxFit.fill
            ),
          ),
          child: SingleChildScrollView(
            child: ValueListenableBuilder(
                ...
                {
                  hourList = List.generate(5, (index) => index + 17);
