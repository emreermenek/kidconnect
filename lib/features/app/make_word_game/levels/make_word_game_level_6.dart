...
class MakeWordGameLevel6 extends ConsumerStatefulWidget {
  const MakeWordGameLevel6({super.key});

  @override
  ConsumerState<MakeWordGameLevel6> createState() => _MakeWordGameLevel6State();
}

class _MakeWordGameLevel6State extends ConsumerState<MakeWordGameLevel6> {
                    ...
                    children: [
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                    ...
                                    child: const Image(image: AssetImage('assets/images/make_word_game_images/ev.png'))),
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel5(),));
                            },
                          ...
                          InkWell(
                            onTap: () {
                              if(data.lock[6] == 'assets/images/level_list/open_lock.png'){
                                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel7(),));
                              }
                            },
