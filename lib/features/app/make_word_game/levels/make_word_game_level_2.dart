...
class MakeWordGameLevel2 extends ConsumerStatefulWidget {
  const MakeWordGameLevel2({super.key});

  @override
  ConsumerState<MakeWordGameLevel2> createState() => _MakeWordGameLevel2State();
}

class _MakeWordGameLevel2State extends ConsumerState<MakeWordGameLevel2> {
                      ...
                      children: [
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      child: const Image(image: AssetImage('assets/images/make_word_game_images/at.png'))),
                                  Text('ı', style: GoogleFonts.comfortaa(
                                      textStyle: const TextStyle(
                                          fontSize: 80,
                                          color: Color(0xFF16519F)
                                      )
                              ...
                              Container(
                                ...
                                child: TextField(
                                  ...
                                  onChanged: (value) {
                                    if(value.toLowerCase() == 'batık'){
                                      _player.setAsset(
                                          'assets/sounds/correct_answer.mp3'
                                      );
                                      _player.play();
                                      data.levelLock(2);
                                      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel3(),));
                                    }
                                  },
                                ),
                              ),
                        ...
                        Row(
                          ...
                          children: [
                            InkWell(
                              onTap: () {
                                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel1(),));
                              },
                            ...
                            InkWell(
                              onTap: () {
                                if(data.lock[2] == 'assets/images/level_list/open_lock.png'){
                                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel3(),));
                                }
                                },
