                      ...
                      children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      child: const Image(image: AssetImage('assets/images/make_word_game_images/in.png'))),
                                  Text('li', style: GoogleFonts.comfortaa(
                                ...
                                child: TextField(
                                  ...
                                  onChanged: (value) {
                                    if(value.toLowerCase() == 'izinli'){
                                      ...
                                      _player.play();
                                      data.levelLock(9);
                                      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel10(),));
                                    }
                                  },
                                ),
                              ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                if(data.lock[9] == 'assets/images/level_list/open_lock.png'){
                                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel10(),));
                                }
                              },
