...
class MakeWordGameLevel7 extends ConsumerStatefulWidget {
  const MakeWordGameLevel7({super.key});

  @override
  ConsumerState<MakeWordGameLevel7> createState() => _MakeWordGameLevel7State();
}

class _MakeWordGameLevel7State extends ConsumerState<MakeWordGameLevel7> {
                      ...
                      children: [
                              ...
                              Row(
                                ...
                                children: [
                                  InkWell(
                                      ...
                                      child: const Image(image: AssetImage('assets/images/make_word_game_images/tır.png'))),
                                  Text('n', style: GoogleFonts.comfortaa(
                                      textStyle: const TextStyle(
                                          fontSize: 80,
                                          color: Color(0xFF16519F)
                                      )
                                  ),),
                                  Text('a', style: GoogleFonts.comfortaa(
                                      textStyle: const TextStyle(
                                          fontSize: 80,
                                          color: Color(0xFF16519F)
                                      )
                                ...
                                child: TextField(
                                  ...
                                  onChanged: (value) {
                                    if(value.toLowerCase() == 'tırnak'){
                                      ...
                                      _player.play();
                                      data.levelLock(7);
                                      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel8(),));
                                    }
                                  },
                                ),
                              ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            InkWell(
                              onTap: () {
                                if(data.lock[7] == 'assets/images/level_list/open_lock.png'){
                                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => const MakeWordGameLevel8(),));
                                }
                              },
