...
class NutritionMakeLogicGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final nutritionMakeLogicGameServiceProvider = ChangeNotifierProvider((ref) => NutritionMakeLogicGameService());