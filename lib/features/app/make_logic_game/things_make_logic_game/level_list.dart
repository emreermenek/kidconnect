...
import 'package:bootcamp_f32/features/app/make_logic_game/things_make_logic_game/things_make_logic_game.dart';
...
class ThingsMakeLogicGameLevelList extends ConsumerStatefulWidget {
  const ThingsMakeLogicGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<ThingsMakeLogicGameLevelList> createState() => _ThingsMakeLogicGameLevelListState();
}

class _ThingsMakeLogicGameLevelListState extends ConsumerState<ThingsMakeLogicGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ThingsMakeLogicGame(),));
                      }else{
