...
class ProfessionMakeLogicGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final professionMakeLogicGameServiceProvider = ChangeNotifierProvider((ref) => ProfessionMakeLogicGameService());