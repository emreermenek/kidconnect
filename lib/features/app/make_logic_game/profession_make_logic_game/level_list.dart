import 'package:bootcamp_f32/features/app/make_logic_game/profession_make_logic_game/profession_make_logic_game.dart';
...
class ProfessionMakeLogicGameLevelList extends ConsumerStatefulWidget {
  const ProfessionMakeLogicGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<ProfessionMakeLogicGameLevelList> createState() => _ProfessionMakeLogicGameLevelListState();
}

class _ProfessionMakeLogicGameLevelListState extends ConsumerState<ProfessionMakeLogicGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ProfessionMakeLogicGame(),));
                      }else{
