...
class CleaningMakeLogicGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final cleaningMakeLogicGameServiceProvider = ChangeNotifierProvider((ref) => CleaningMakeLogicGameService());