...
class AnimalMakeLogicGameLevelList extends ConsumerStatefulWidget {
  const AnimalMakeLogicGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<AnimalMakeLogicGameLevelList> createState() => _AnimalMakeLogicGameLevelListState();
}

class _AnimalMakeLogicGameLevelListState extends ConsumerState<AnimalMakeLogicGameLevelList> {
  List<String> levels =
  [
    ...
    'bölüm 21','bölüm 22','bölüm 23','bölüm 24'
  ];
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const AnimalMakeLogicGame(),));
                      }else{
