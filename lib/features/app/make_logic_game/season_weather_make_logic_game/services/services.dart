...
class SeasonWeatherMakeLogicGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final seasonWeatherMakeLogicGameServiceProvider = ChangeNotifierProvider((ref) => SeasonWeatherMakeLogicGameService());