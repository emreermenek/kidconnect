...
import 'package:bootcamp_f32/features/app/make_logic_game/shapes_make_logic_game/shapes_make_logic_game.dart';
...
class ShapesMakeLogicGameLevelList extends ConsumerStatefulWidget {
  const ShapesMakeLogicGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<ShapesMakeLogicGameLevelList> createState() => _ShapesMakeLogicGameLevelListState();
}

class _ShapesMakeLogicGameLevelListState extends ConsumerState<ShapesMakeLogicGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ShapesMakeLogicGame(),));
                      }else{
