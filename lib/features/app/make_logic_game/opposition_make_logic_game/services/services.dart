...
class OppositionMakeLogicGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final oppositionMakeLogicGameServiceProvider = ChangeNotifierProvider((ref) => OppositionMakeLogicGameService());