...
class OppositionMakeLogicGameLevelList extends ConsumerStatefulWidget {
  const OppositionMakeLogicGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<OppositionMakeLogicGameLevelList> createState() => _OppositionMakeLogicGameLevelListState();
}

class _OppositionMakeLogicGameLevelListState extends ConsumerState<OppositionMakeLogicGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const OppositionMakeLogicGame(),));
                      }else{
