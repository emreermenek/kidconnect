...
import '../choose_correct_game/data/numbers.dart';
                  ...
                  [
                    const Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Image(image: AssetImage('assets/images/number_game_image/btn_cik.png'))
                        ],
                      ),
                    ),
                    Expanded(
                                          ...
                                          InkWell(
                                              onTap: () {
                                                ...
                                                if(readAtFirstOpen == true){
                                                  textToSpeech(shapeNamesNumber[whichImageIndex]);
                                                  setState(() {
