...
class WhoseSoundGameLevelList extends ConsumerStatefulWidget {
  const WhoseSoundGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<WhoseSoundGameLevelList> createState() => _WhoseSoundGameLevelListState();
}

class _WhoseSoundGameLevelListState extends ConsumerState<WhoseSoundGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const WhoseSoundGame(),));
                      }else{
