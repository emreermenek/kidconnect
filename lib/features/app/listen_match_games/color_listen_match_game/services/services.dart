...
class ColorListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final colorListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => ColorListenMatchGameService());