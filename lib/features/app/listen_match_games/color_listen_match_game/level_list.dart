import 'package:bootcamp_f32/features/app/listen_match_games/color_listen_match_game/color_listen_match_game.dart';
...
class ColorListenMatchGameLevelList extends ConsumerStatefulWidget {
  const ColorListenMatchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<ColorListenMatchGameLevelList> createState() => _ColorListenMatchGameLevelListState();
}

class _ColorListenMatchGameLevelListState extends ConsumerState<ColorListenMatchGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ColorListenMatchGame(),));
                      }else{
