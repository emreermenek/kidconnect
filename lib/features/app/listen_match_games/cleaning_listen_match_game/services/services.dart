...
class CleaningListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final cleaningListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => CleaningListenMatchGameService());