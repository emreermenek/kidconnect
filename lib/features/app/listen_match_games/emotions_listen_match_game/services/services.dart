...
class EmotionsListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final emotionsListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => EmotionsListenMatchGameService());