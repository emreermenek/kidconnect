...
class NumbersListenMatchGameLevelList extends ConsumerStatefulWidget {
  const NumbersListenMatchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<NumbersListenMatchGameLevelList> createState() => _NumbersListenMatchGameLevelListState();
}

class _NumbersListenMatchGameLevelListState extends ConsumerState<NumbersListenMatchGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const NumbersListenMatchGame(),));
                      }else{
