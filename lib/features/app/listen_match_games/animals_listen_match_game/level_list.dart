...
class AnimalsListenMatchGameLevelList extends ConsumerStatefulWidget {
  const AnimalsListenMatchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<AnimalsListenMatchGameLevelList> createState() => _AnimalsListenMatchGameLevelListState();
}

class _AnimalsListenMatchGameLevelListState extends ConsumerState<AnimalsListenMatchGameLevelList> {
  List<String> levels =
  [
    ...
    'bölüm 21','bölüm 22','bölüm 23','bölüm 24','bölüm 25', 'bölüm 26'
  ];
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const AnimalsListenMatchGame(),));
                      }else{
