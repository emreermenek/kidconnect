...
class AnimalsListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final animalsListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => AnimalsListenMatchGameService());