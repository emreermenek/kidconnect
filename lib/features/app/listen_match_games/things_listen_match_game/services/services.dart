...
class ThingsListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final thingsListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => ThingsListenMatchGameService());