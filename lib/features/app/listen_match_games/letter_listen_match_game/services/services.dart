...
class LetterListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final letterListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => LetterListenMatchGameService());