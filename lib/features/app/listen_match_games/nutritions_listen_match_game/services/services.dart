...
class NutritionsListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final nutritionsListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => NutritionsListenMatchGameService());