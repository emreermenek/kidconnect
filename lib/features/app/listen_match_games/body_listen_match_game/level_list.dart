...
class BodyListenMatchGameLevelList extends ConsumerStatefulWidget {
  const BodyListenMatchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<BodyListenMatchGameLevelList> createState() => _BodyListenMatchGameLevelListState();
}

class _BodyListenMatchGameLevelListState extends ConsumerState<BodyListenMatchGameLevelList> {
  List<String> levels =
  [
  ...
  Widget build(BuildContext context) {
    final data = ref.watch(bodyListenMatchGameServiceProvider);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const BodyListenMatchGame(),));
                      }else{
