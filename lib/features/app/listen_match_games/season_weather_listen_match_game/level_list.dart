import 'package:bootcamp_f32/features/app/listen_match_games/season_weather_listen_match_game/season_weather_listen_match_game.dart';
...
class SeasonWeatherListenMatchGameLevelList extends ConsumerStatefulWidget {
  const SeasonWeatherListenMatchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<SeasonWeatherListenMatchGameLevelList> createState() => _SeasonWeatherListenMatchGameLevelListState();
}

class _SeasonWeatherListenMatchGameLevelListState extends ConsumerState<SeasonWeatherListenMatchGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const SeasonWeatherListenMatchGame(),));
                      }else{
