...
class ShapesListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final shapesListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => ShapesListenMatchGameService());