...
import 'package:bootcamp_f32/features/app/listen_match_games/shapes_listen_match_game/shapes_listen_match_game.dart';
...
class ShapesListenMatchGameLevelList extends ConsumerStatefulWidget {
  const ShapesListenMatchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<ShapesListenMatchGameLevelList> createState() => _ShapesListenMatchGameLevelListState();
}

class _ShapesListenMatchGameLevelListState extends ConsumerState<ShapesListenMatchGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ShapesListenMatchGame(),));
                      }else{
