import 'package:bootcamp_f32/features/app/listen_match_games/profession_listen_match_game/profession_listen_match_game.dart';
...
class ProfessionListenMatchGameLevelList extends ConsumerStatefulWidget {
  const ProfessionListenMatchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<ProfessionListenMatchGameLevelList> createState() => _ProfessionListenMatchGameLevelListState();
}

class _ProfessionListenMatchGameLevelListState extends ConsumerState<ProfessionListenMatchGameLevelList> {
  List<String> levels =
  [
  ...
  Widget build(BuildContext context) {
    final data = ref.watch(professionListenMatchGameServiceProvider);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ProfessionListenMatchGame(),));
                      }else{
