...
class ProfessionListenMatchGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final professionListenMatchGameServiceProvider = ChangeNotifierProvider((ref) => ProfessionListenMatchGameService());