...
import 'package:bootcamp_f32/features/app/choose_correct_game/data/correct_level_data.dart';
import 'package:bootcamp_f32/features/app/choose_correct_game/data/marks.dart';
import 'package:bootcamp_f32/features/app/choose_correct_game/data/numbers.dart';
import 'package:bootcamp_f32/features/app/choose_correct_game/services/data_service.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:just_audio/just_audio.dart';

class ChooseCorrectGame extends ConsumerStatefulWidget {
  const ChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<ChooseCorrectGame> createState() => _ChooseCorrectGameState();
}

class _ChooseCorrectGameState extends ConsumerState<ChooseCorrectGame> {
  int? number1Value;
  int? number2Value;
  int? number3Value;
  int? number4Value;
