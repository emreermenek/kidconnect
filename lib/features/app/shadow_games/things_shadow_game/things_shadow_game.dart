...
class ThingsShadowGame extends ConsumerStatefulWidget {
  const ThingsShadowGame({super.key});

  @override
  ConsumerState<ThingsShadowGame> createState() => _ThingsShadowGameState();
}

class _ThingsShadowGameState extends ConsumerState<ThingsShadowGame> {
                                ...
                                children: [
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(thingShadowGameImages[firstIndex])
                                          )
                                      ),
                                    ),
                                  ...
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(thingShadowGameImages[secondIndex])
                                          )
                                      ),
                                    ),
                                    childWhenDragging: Image(
