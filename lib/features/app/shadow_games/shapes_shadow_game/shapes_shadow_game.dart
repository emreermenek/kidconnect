...
class ShapesShadowGame extends ConsumerStatefulWidget {
  const ShapesShadowGame({super.key});

  @override
  ConsumerState<ShapesShadowGame> createState() => _ShapesShadowGameState();
}

class _ShapesShadowGameState extends ConsumerState<ShapesShadowGame> {
                                ...
                                children: [
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(shapeShadowGamesImages[firstIndex])
                                          )
                                      ),
                                    ),
                                  ...
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(shapeShadowGamesImages[secondIndex])
                                          )
                                      ),
                                    ),
                                    childWhenDragging: Image(
