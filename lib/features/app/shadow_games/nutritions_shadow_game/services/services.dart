...
class NutritionsShadowGameService extends ChangeNotifier{
  int currentLevel = 0;
...
final nutritionsShadowGameServiceProvider = ChangeNotifierProvider((ref) => NutritionsShadowGameService());