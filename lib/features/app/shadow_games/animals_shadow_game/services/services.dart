...
class AnimalShadowGameDataService extends ChangeNotifier{
  int currentLevel = 0;
...
final animalShadowGameDataServiceProvider = ChangeNotifierProvider((ref) => AnimalShadowGameDataService());