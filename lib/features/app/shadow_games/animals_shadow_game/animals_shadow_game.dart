...
class AnimalsShadowGame extends ConsumerStatefulWidget {
  const AnimalsShadowGame({super.key});

  @override
  ConsumerState<AnimalsShadowGame> createState() => _AnimalsShadowGameState();
}

class _AnimalsShadowGameState extends ConsumerState<AnimalsShadowGame> {
                                ...
                                children: [
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(animalShadowGameImages[firstIndex])
                                          )
                                      ),
                                    ),
                                  ...
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(animalShadowGameImages[secondIndex])
                                          )
                                      ),
                                    ),
                                    childWhenDragging: Image(
