...
class SeasonWeatherShadowGame extends ConsumerStatefulWidget {
  const SeasonWeatherShadowGame({super.key});

  @override
  ConsumerState<SeasonWeatherShadowGame> createState() => _SeasonWeatherShadowGameState();
}

class _SeasonWeatherShadowGameState extends ConsumerState<SeasonWeatherShadowGame> {
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(seasonWeatherShadowGameImages[secondIndex])
                                          )
                                      ),
                                    ),
                                ...
                                children: [
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(seasonWeatherShadowGameImages[firstIndex])
                                          )
                                      ),
                                    ),
                                    childWhenDragging: Image(
                                  ...
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(seasonWeatherShadowGameImages[thirdIndex])
                                          )
                                      ),
                                    ),
                                    childWhenDragging: Image(
