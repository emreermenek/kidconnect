...
class ProfessionsShadowGameService extends ChangeNotifier{
  int currentLevel = 0;
...
final professionsShadowGameServiceProvider = ChangeNotifierProvider((ref) => ProfessionsShadowGameService());