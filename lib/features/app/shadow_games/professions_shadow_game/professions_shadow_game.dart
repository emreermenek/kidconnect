...
class ProfessionsShadowGame extends ConsumerStatefulWidget {
  const ProfessionsShadowGame({super.key});

  @override
  ConsumerState<ProfessionsShadowGame> createState() => _ProfessionsShadowGameState();
}

class _ProfessionsShadowGameState extends ConsumerState<ProfessionsShadowGame> {
                                ...
                                children: [
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(professionShadowGameImages[firstIndex])
                                          )
                                      ),
                                    ),
                                  ...
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(professionShadowGameImages[secondIndex])
                                          )
                                      ),
                                    ),
                                    childWhenDragging: Image(
