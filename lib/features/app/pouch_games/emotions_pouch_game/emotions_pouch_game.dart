...
class EmotionsPouchGame extends ConsumerStatefulWidget {
  const EmotionsPouchGame({super.key});

  @override
  ConsumerState<EmotionsPouchGame> createState() => _EmotionsPouchGameState();
}

class _EmotionsPouchGameState extends ConsumerState<EmotionsPouchGame> {
  int firstIndex =0;
  int secondIndex = 0;
  int thirdIndex = 0;
  int correctAnswer = 3;
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(emotionPouchGameNames[b], style: GoogleFonts.quicksand(
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(emotionPouchGameImages[secondIndex])
                                            )
                                        ),
                                      ),
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(emotionPouchGameImages[firstIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
                                    ...
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(emotionPouchGameImages[thirdIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
