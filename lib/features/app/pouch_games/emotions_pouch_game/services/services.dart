...
class EmotionsPouchGameDataService extends ChangeNotifier{
  int currentLevel = 0;
...
final emotionsPouchGameDataServiceProvider = ChangeNotifierProvider((ref) => EmotionsPouchGameDataService());