...
class AnimalsPouchGame extends ConsumerStatefulWidget {
  const AnimalsPouchGame({super.key});

  @override
  ConsumerState<AnimalsPouchGame> createState() => _AnimalsPouchGameState();
}

class _AnimalsPouchGameState extends ConsumerState<AnimalsPouchGame> {
  int firstIndex =0;
  int secondIndex = 0;
  int correctAnswer = 2;
        ...
        body: ValueListenableBuilder(
            ...
            builder: (BuildContext context, value, Widget? child) {
              if(data.imageIndexList.isEmpty){
                data.currentLevel = 0;
                data.imageIndexList = List.generate(26, (index) => index);
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(animalPouchGameNames[b], style: GoogleFonts.quicksand(
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(animalPouchGameImages[secondIndex])
                                            )
                                        ),
                                      ),
                                    ...
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(animalPouchGameImages[firstIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
