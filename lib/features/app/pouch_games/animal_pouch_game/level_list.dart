...
import 'package:bootcamp_f32/features/app/pouch_games/animal_pouch_game/services/services.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:google_fonts/google_fonts.dart';
import '../../../../utils/utils.dart';

class AnimalsPouchGameLevelList extends ConsumerStatefulWidget {
  const AnimalsPouchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<AnimalsPouchGameLevelList> createState() => _AnimalsPouchGameLevelListState();
}

class _AnimalsPouchGameLevelListState extends ConsumerState<AnimalsPouchGameLevelList> {
  List<String> levels =
  [
    'bölüm 1','bölüm 2','bölüm 3','bölüm 4','bölüm 5','bölüm 6','bölüm 7','bölüm 8','bölüm 9',
    'bölüm 10','bölüm 11', 'bölüm 12','bölüm 13'
  ];

  @override
  Widget build(BuildContext context) {
    final data = ref.watch(animalsPouchGameDataServiceProvider);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const AnimalsPouchGame(),));
                      }else{
