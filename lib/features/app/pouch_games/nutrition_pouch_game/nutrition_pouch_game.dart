...
class NutritionPouchGame extends ConsumerStatefulWidget {
  const NutritionPouchGame({super.key});

  @override
  ConsumerState<NutritionPouchGame> createState() => _NutritionPouchGameState();
}

class _NutritionPouchGameState extends ConsumerState<NutritionPouchGame> {
  int firstIndex =0;
  int secondIndex = 0;
  int correctAnswer = 2;
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(nutritionPouchGameNames[b], style: GoogleFonts.quicksand(
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(nutritionPouchGameImages[secondIndex])
                                            )
                                        ),
                                      ),
                                    ...
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(nutritionPouchGameImages[firstIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
