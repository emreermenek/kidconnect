import 'package:bootcamp_f32/features/app/pouch_games/seasonWeather_pouch_game/seasonWeather_pouch_game.dart';
...
class SeasonWeatherPouchGameLevelList extends ConsumerStatefulWidget {
  const SeasonWeatherPouchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<SeasonWeatherPouchGameLevelList> createState() => _SeasonWeatherPouchGameLevelListState();
}

class _SeasonWeatherPouchGameLevelListState extends ConsumerState<SeasonWeatherPouchGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const SeasonWeatherPouchGame(),));
                      }else{
