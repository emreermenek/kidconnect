...
class SeasonWeatherPouchGameDataService extends ChangeNotifier{
  int currentLevel = 0;
...
final seasonWeatherPouchGameDataServiceProvider = ChangeNotifierProvider((ref) => SeasonWeatherPouchGameDataService());