...
class CleaningPouchGame extends ConsumerStatefulWidget {
  const CleaningPouchGame({super.key});

  @override
  ConsumerState<CleaningPouchGame> createState() => _CleaningPouchGameState();
}

class _CleaningPouchGameState extends ConsumerState<CleaningPouchGame> {
  int firstIndex =0;
  int secondIndex = 0;
  int correctAnswer = 2;
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(cleaningPouchGameImages[secondIndex])
                                            )
                                        ),
                                      ),
                                    ...
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(cleaningPouchGameImages[firstIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
