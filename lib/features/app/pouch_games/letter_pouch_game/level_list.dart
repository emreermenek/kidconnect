import 'package:bootcamp_f32/features/app/pouch_games/letter_pouch_game/letter_pouch_game.dart';
import 'package:bootcamp_f32/features/app/pouch_games/letter_pouch_game/services/services.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:google_fonts/google_fonts.dart';
import '../../../../utils/utils.dart';

class LetterPouchGameLevelList extends ConsumerStatefulWidget {
  const LetterPouchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<LetterPouchGameLevelList> createState() => _LetterPouchGameLevelListState();
}

class _LetterPouchGameLevelListState extends ConsumerState<LetterPouchGameLevelList> {
  List<String> levels =
  [
  ...
  Widget build(BuildContext context) {
    final data = ref.watch(letterPouchGameDataServiceProvider);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const LetterPouchGame(),));
                      }else{
