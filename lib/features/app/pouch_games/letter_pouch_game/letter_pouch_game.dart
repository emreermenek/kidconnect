...
class LetterPouchGame extends ConsumerStatefulWidget {
  const LetterPouchGame({super.key});

  @override
  ConsumerState<LetterPouchGame> createState() => _LetterPouchGameState();
}

class _LetterPouchGameState extends ConsumerState<LetterPouchGame> {
  int firstIndex =0;
  int secondIndex = 0;
  int correctAnswer = 2;
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(letterPouchGameNames[b], style: GoogleFonts.quicksand(
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(letterPouchGameImages[secondIndex])
                                            )
                                        ),
                                      ),
                                    ...
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(letterPouchGameImages[firstIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
