...
class ProfessionPouchGameDataService extends ChangeNotifier{
  int currentLevel = 0;
...
final professionPouchGameDataServiceProvider = ChangeNotifierProvider((ref) => ProfessionPouchGameDataService());