...
import 'package:bootcamp_f32/features/app/pouch_games/profession_pouch_game/profession_pouch_game.dart';
...
class ProfessionPouchGameLevelList extends ConsumerStatefulWidget {
  const ProfessionPouchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<ProfessionPouchGameLevelList> createState() => _ProfessionPouchGameLevelListState();
}

class _ProfessionPouchGameLevelListState extends ConsumerState<ProfessionPouchGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ProfessionPouchGame(),));
                      }else{
