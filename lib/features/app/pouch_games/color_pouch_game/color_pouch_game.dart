...
class ColorPouchGame extends ConsumerStatefulWidget {
  const ColorPouchGame({super.key});

  @override
  ConsumerState<ColorPouchGame> createState() => _ColorPouchGameState();
}

class _ColorPouchGameState extends ConsumerState<ColorPouchGame> {
  int firstIndex =0;
  int secondIndex = 0;
  int thirdIndex = 0;
  int correctAnswer = 3;
        ...
        body: ValueListenableBuilder(
            ...
            builder: (BuildContext context, value, Widget? child) {
              if(data.imageIndexList.isEmpty){
                data.currentLevel = 0;
                data.imageIndexList = List.generate(9, (index) => index);
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(colorPouchGameImages[secondIndex])
                                            )
                                        ),
                                      ),
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(colorPouchGameImages[firstIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
                                    ...
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(colorPouchGameImages[thirdIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
