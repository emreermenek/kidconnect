...
class BodyPouchGame extends ConsumerStatefulWidget {
  const BodyPouchGame({super.key});

  @override
  ConsumerState<BodyPouchGame> createState() => _BodyPouchGameState();
}

class _BodyPouchGameState extends ConsumerState<BodyPouchGame> {
  int firstIndex =0;
  int secondIndex = 0;
  int thirdIndex = 0;
  int correctAnswer = 3;
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: Text(bodyPouchGameNames[b], style: GoogleFonts.quicksand(
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(bodyPouchGameImages[secondIndex])
                                            )
                                        ),
                                      ),
                                  ...
                                  children: [
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(bodyPouchGameImages[firstIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
                                    ...
                                    Draggable<int>(
                                      ...
                                      feedback:  Container(
                                        ...
                                        decoration: BoxDecoration(
                                            image: DecorationImage(
                                                image: AssetImage(bodyPouchGameImages[thirdIndex])
                                            )
                                        ),
                                      ),
                                      childWhenDragging: Image(
