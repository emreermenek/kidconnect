...
class NumbersPouchGame extends ConsumerStatefulWidget {
  const NumbersPouchGame({super.key});

  @override
  ConsumerState<NumbersPouchGame> createState() => _NumbersPouchGameState();
}

class _NumbersPouchGameState extends ConsumerState<NumbersPouchGame> {
  int firstIndex =0;
  int secondIndex = 0;
  int thirdIndex = 0;
  int correctAnswer = 3;
  ...
  Widget build(BuildContext context) {
    final data = ref.watch(numbersPouchGameDataServiceProvider);
                        ...
                        Row(
                          children: [
                            ...
                            Container(
                              ...
                              child: Center(
                                child: Text(numberPouchGameNames[b], style: GoogleFonts.quicksand(
                                ...
                                children: [
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(numberPouchGameGameImage[secondIndex])
                                          )
                                      ),
                                    ),
                                ...
                                children: [
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(numberPouchGameGameImage[firstIndex])
                                          )
                                      ),
                                    ),
                                    childWhenDragging: Image(
                                  ...
                                  Draggable<int>(
                                    ...
                                    feedback:  Container(
                                      ...
                                      decoration: BoxDecoration(
                                          image: DecorationImage(
                                              image: AssetImage(numberPouchGameGameImage[thirdIndex])
                                          )
                                      ),
                                    ),
                                    childWhenDragging: Image(
