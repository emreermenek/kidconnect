...
class NumbersPouchGameLevelList extends ConsumerStatefulWidget {
  const NumbersPouchGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<NumbersPouchGameLevelList> createState() => _NumbersPouchGameLevelListState();
}

class _NumbersPouchGameLevelListState extends ConsumerState<NumbersPouchGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lock[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const NumbersPouchGame(),));
                      }else{
