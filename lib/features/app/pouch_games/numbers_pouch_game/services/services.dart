...
class NumbersPouchGameDataService extends ChangeNotifier{
  int currentLevel = 0;
...
final numbersPouchGameDataServiceProvider = ChangeNotifierProvider((ref) => NumbersPouchGameDataService());