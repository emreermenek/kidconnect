...
class EasyColorChooseCorrectGame extends ConsumerStatefulWidget {
  const EasyColorChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyColorChooseCorrectGame> createState() =>
      _EasyColorChooseCorrectGameState();
}

class _EasyColorChooseCorrectGameState
    extends ConsumerState<EasyColorChooseCorrectGame> {
                       ...
                       children: [
                         ...
                         Row(
                           children: [
                             ...
                             Text('${easyNames[data.currentLevelEasy]} renkli\n   balonu\n   bulalım', style: GoogleFonts.comfortaa(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text('${data.currentLevelEasy+1}/9',
                                          ...
                                          InkWell(
                                            onTap: (){
                                              ...
                                              if(data.currentLevelEasy != 8){
                                                ...
                                                _player.play();
                                              }else if(data.currentLevelEasy == 8){
                                                Navigator.of(context).pop();
                                              }
                                              data.levelLockEasy();
                                             },
                                              child: Image(image: AssetImage(easyImages[data.currentLevelEasy]),width: 200)),
                                        ],
                                      ),
                                      Column(
                                        children: [
                                          ...
                                          InkWell(
                                              ...
                                              child: Image(image: AssetImage(easyImages[imageIndexList![whichImage!]]),width: 200)),
                                        ],
                                      ),
                                    ],
                                  ),
