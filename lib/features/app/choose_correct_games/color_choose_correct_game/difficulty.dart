import 'package:bootcamp_f32/features/app/choose_correct_games/color_choose_correct_game/easy_level_list.dart';
import 'package:flutter/material.dart';

import 'hard_level_list.dart';

class ColorChooseCorrectGameDifficulty extends StatefulWidget {
  const ColorChooseCorrectGameDifficulty({super.key});

  @override
  State<ColorChooseCorrectGameDifficulty> createState() => _ColorChooseCorrectGameDifficultyState();
}

class _ColorChooseCorrectGameDifficultyState extends State<ColorChooseCorrectGameDifficulty> {
  @override
