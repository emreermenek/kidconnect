...
class ColorChooseCorrectGameService extends ChangeNotifier{
  int currentLevel = 0;
  List<String> lock =
  [
...
final colorChooseCorrectGameServiceProvider = ChangeNotifierProvider((ref) => ColorChooseCorrectGameService());