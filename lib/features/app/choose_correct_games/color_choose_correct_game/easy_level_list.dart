...
class EasyColorChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyColorChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyColorChooseCorrectGameLevelList> createState() => _EasyColorChooseCorrectGameLevelListState();
}

class _EasyColorChooseCorrectGameLevelListState extends ConsumerState<EasyColorChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockEasy[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EasyColorChooseCorrectGame(),));
                      }else{
