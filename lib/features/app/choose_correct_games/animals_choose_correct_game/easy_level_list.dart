...
class EasyAnimalChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyAnimalChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyAnimalChooseCorrectGameLevelList> createState() => _EasyAnimalChooseCorrectGameLevelListState();
}

class _EasyAnimalChooseCorrectGameLevelListState extends ConsumerState<EasyAnimalChooseCorrectGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockEasy[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EasyAnimalChooseCorrectGame(),));
                      }else{
