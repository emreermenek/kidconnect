...
class HardVegetablesChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const HardVegetablesChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<HardVegetablesChooseCorrectGameLevelList> createState() => _HardVegetablesChooseCorrectGameLevelListState();
}

class _HardVegetablesChooseCorrectGameLevelListState extends ConsumerState<HardVegetablesChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockHard[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const HardVegetablesChooseCorrectGame(),));
                      }else{
