...
class HardVegetablesChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HardVegetablesChooseCorrectGameLevelList> createState() =>
      _HardVegetablesChooseCorrectGameLevelListState();
}

class _HardVegetablesChooseCorrectGameLevelListState
    extends ConsumerState<HardVegetablesChooseCorrectGameLevelList> {
  List<String> levels = [
    'bölüm 1',
    'bölüm 2',
    'bölüm 3',
                    ...
                    onTap: () {
                      if (data.lockHard[index] ==
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              const HardVegetablesChooseCorrectGame(),
                        ));
                      } else {
