...
class HardFoodsChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const HardFoodsChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<HardFoodsChooseCorrectGameLevelList> createState() => _HardFoodsChooseCorrectGameLevelListState();
}

class _HardFoodsChooseCorrectGameLevelListState extends ConsumerState<HardFoodsChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockHard[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const HardFoodChooseCorrectGame(),));
                      }else{
