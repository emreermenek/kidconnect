...
class HardFoodsChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HardFoodsChooseCorrectGameLevelList> createState() =>
      _HardFoodsChooseCorrectGameLevelListState();
}

class _HardFoodsChooseCorrectGameLevelListState
    extends ConsumerState<HardFoodsChooseCorrectGameLevelList> {
  List<String> levels = [
    'bölüm 1',
    'bölüm 2',
    'bölüm 3',
                    ...
                    onTap: () {
                      if (data.lockHard[index] ==
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              const HardFoodChooseCorrectGame(),
                        ));
                      } else {
