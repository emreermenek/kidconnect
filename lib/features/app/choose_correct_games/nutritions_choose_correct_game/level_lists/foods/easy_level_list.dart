...
class EasyFoodsChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyFoodsChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyFoodsChooseCorrectGameLevelList> createState() => _EasyFoodsChooseCorrectGameLevelListState();
}

class _EasyFoodsChooseCorrectGameLevelListState extends ConsumerState<EasyFoodsChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockEasy[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EasyFoodChooseCorrectGame(),));
                      }else{
