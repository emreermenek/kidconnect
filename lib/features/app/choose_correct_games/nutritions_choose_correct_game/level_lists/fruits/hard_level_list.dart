...
class HardFruitsChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const HardFruitsChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<HardFruitsChooseCorrectGameLevelList> createState() => _HardFruitsChooseCorrectGameLevelListState();
}

class _HardFruitsChooseCorrectGameLevelListState extends ConsumerState<HardFruitsChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockHard[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const HardFruitChooseCorrectGame(),));
                      }else{
