...
class EasyFruitChooseCorrectGame extends ConsumerStatefulWidget {
  const EasyFruitChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyFruitChooseCorrectGame> createState() =>
      _EasyFruitChooseCorrectGameState();
}

class _EasyFruitChooseCorrectGameState
    extends ConsumerState<EasyFruitChooseCorrectGame> {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${fruitNamesList[data.currentLevelEasy]}\nbulalım', style: GoogleFonts.comfortaa(
                                      ...
                                      Column(
                                        children: [
                                          InkWell(
                                              ...
                                              child: Image(image: AssetImage(fruitImagesList[data.currentLevelEasy]),width: 200)),
                                        ],
                                      ),
                                      Column(
                                        children: [
                                          ...
                                          InkWell(
                                              ...
                                              child: Image(image: AssetImage(fruitImagesList[imageIndexList![whichImage!]]),width: 200)),
                                        ],
                                      ),
                                    ],
                                  ),
