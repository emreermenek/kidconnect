...
class HardBodyChooseCorrectGame extends ConsumerStatefulWidget {
  const HardBodyChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<HardBodyChooseCorrectGame> createState() =>
      _HardBodyChooseCorrectGameState();
}

class _HardBodyChooseCorrectGameState
    extends ConsumerState<HardBodyChooseCorrectGame> {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${bodyNamesList[data.currentLevelHard]} bulalım', style: GoogleFonts.comfortaa(
                                          ...
                                          Column(
                                            children: [
                                              ...
                                              InkWell(
                                                  ...
                                                  child: Image(image: AssetImage(bodyImagesList[imageIndexList![whichImage!]]),width: 120,)),
                                            ],
                                          ),
                                          Column(
                                            children: [
                                              InkWell(
                                                  ...
                                                  child: Image(image: AssetImage(bodyImagesList[data.currentLevelHard]),width: 120,)),
                                            ],
                                          ),
                                          Column(
                                            children: [
                                              ...
                                              InkWell(
                                                  ...
                                                  child: Image(image: AssetImage(bodyImagesList[imageIndexList![whichImage2!]]),width: 120,)),
                                            ],
                                          ),
                                        ],
                                      ),
