...
class EasyBodyChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyBodyChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyBodyChooseCorrectGameLevelList> createState() => _EasyBodyChooseCorrectGameLevelListState();
}

class _EasyBodyChooseCorrectGameLevelListState extends ConsumerState<EasyBodyChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockEasy[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EasyBodyChooseCorrectGame(),));
                      }else{
