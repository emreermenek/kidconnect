...
class EasyBodyChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EasyBodyChooseCorrectGameLevelList> createState() =>
      _EasyBodyChooseCorrectGameLevelListState();
}

class _EasyBodyChooseCorrectGameLevelListState
    extends ConsumerState<EasyBodyChooseCorrectGameLevelList> {
  List<String> levels = [
    'bölüm 1',
    'bölüm 2',
    'bölüm 3',
                    ...
                    onTap: () {
                      if (data.lockEasy[index] ==
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              const EasyBodyChooseCorrectGame(),
                        ));
                      } else {
