...
class HardLetterChooseCorrectGame extends ConsumerStatefulWidget {
  const HardLetterChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<HardLetterChooseCorrectGame> createState() =>
      _HardLetterChooseCorrectGameState();
}

class _HardLetterChooseCorrectGameState
    extends ConsumerState<HardLetterChooseCorrectGame> {
        ...
        body: SizedBox(
          ...
          child: ValueListenableBuilder(
              ...
              builder: (BuildContext context, value, Widget? child) {
                ...
                whichImage = Random().nextInt(27);
                imageIndexList!.removeAt(whichImage!);
                whichImage2 = Random().nextInt(26);
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${letterNamesList[data.currentLevelHard]} harfini\n bulalım', style: GoogleFonts.comfortaa(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${data.currentLevelHard+1}/29',
                                        ...
                                        children: [
                                          InkWell(
                                              onTap: (){
                                                ...
                                                _player.play();
                                                if(data.currentLevelHard != 28){
                                                  setState(() {
                                                    data.currentLevelHard +=1;
                                                  });
                                                }else if(data.currentLevelHard == 28){
                                                  Navigator.of(context).pop();
                                                }
                                                data.levelLockHard();
                                              },
