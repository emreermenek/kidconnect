import 'package:bootcamp_f32/features/app/choose_correct_games/letter_choose_correct_game/easy_letter_choose_correct_game.dart';
...
class EasyLetterChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyLetterChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyLetterChooseCorrectGameLevelList> createState() => _EasyLetterChooseCorrectGameLevelListState();
}

class _EasyLetterChooseCorrectGameLevelListState extends ConsumerState<EasyLetterChooseCorrectGameLevelList> {
  List<String> levels =
  [
  ...
  Widget build(BuildContext context) {
    final data = ref.watch(letterChooseCorrectGameServiceProvider);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockEasy[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EasyLetterChooseCorrectGame(),));
                      }else{
