...
class HardLetterChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const HardLetterChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<HardLetterChooseCorrectGameLevelList> createState() => _HardLetterChooseCorrectGameLevelListState();
}

class _HardLetterChooseCorrectGameLevelListState extends ConsumerState<HardLetterChooseCorrectGameLevelList> {
  List<String> levels =
  [
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockHard[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const HardLetterChooseCorrectGame(),));
                      }else{
