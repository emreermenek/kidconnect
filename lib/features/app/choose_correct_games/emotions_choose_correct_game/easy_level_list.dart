import 'package:bootcamp_f32/features/app/choose_correct_games/emotions_choose_correct_game/easy_emotions_choose_correct_game.dart';
...
class EasyEmotionsChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyEmotionsChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyEmotionsChooseCorrectGameLevelList> createState() => _EasyEmotionsChooseCorrectGameLevelListState();
}

class _EasyEmotionsChooseCorrectGameLevelListState extends ConsumerState<EasyEmotionsChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockEasy[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EasyEmotionsChooseCorrectGame(),));
                      }else{
