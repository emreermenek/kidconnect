...
class EasyShapesChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyShapesChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyShapesChooseCorrectGameLevelList> createState() =>
      _EasyShapesChooseCorrectGameLevelListState();
}

class _EasyShapesChooseCorrectGameLevelListState
    extends ConsumerState<EasyShapesChooseCorrectGameLevelList> {
  List<String> levels = [
    'bölüm 1',
    'bölüm 2',
    'bölüm 3',
                    ...
                    onTap: () {
                      if (data.lockEasy[index] ==
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              const EasyShapesChooseCorrectGame(),
                        ));
                      } else {
