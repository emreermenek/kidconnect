...
class EasyShapesChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EasyShapesChooseCorrectGameLevelList> createState() => _EasyShapesChooseCorrectGameLevelListState();
}

class _EasyShapesChooseCorrectGameLevelListState extends ConsumerState<EasyShapesChooseCorrectGameLevelList> {
  List<String> levels =
