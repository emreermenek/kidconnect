...
class HardShapesChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const HardShapesChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<HardShapesChooseCorrectGameLevelList> createState() =>
      _HardShapesChooseCorrectGameLevelListState();
}

class _HardShapesChooseCorrectGameLevelListState
    extends ConsumerState<HardShapesChooseCorrectGameLevelList> {
  List<String> levels = [
    'bölüm 1',
    'bölüm 2',
    'bölüm 3',
                    ...
                    onTap: () {
                      if (data.lockHard[index] ==
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              const HardShapesChooseCorrectGame(),
                        ));
                      } else {
