...
class HardShapesChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<HardShapesChooseCorrectGameLevelList> createState() => _HardShapesChooseCorrectGameLevelListState();
}

class _HardShapesChooseCorrectGameLevelListState extends ConsumerState<HardShapesChooseCorrectGameLevelList> {
  List<String> levels =
