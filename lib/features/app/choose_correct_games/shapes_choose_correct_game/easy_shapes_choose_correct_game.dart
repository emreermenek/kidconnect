...
class EasyShapesChooseCorrectGame extends ConsumerStatefulWidget {
  const EasyShapesChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyShapesChooseCorrectGame> createState() =>
      _EasyShapesChooseCorrectGameState();
}

class _EasyShapesChooseCorrectGameState
    extends ConsumerState<EasyShapesChooseCorrectGame> {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${shapesNamesList[data.currentLevelEasy]}\n bulalım', style: GoogleFonts.comfortaa(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${data.currentLevelEasy+1}/7',
                                          ...
                                          InkWell(
                                              onTap: (){
                                                ...
                                                if(data.currentLevelEasy != 6){
                                                  ...
                                                  _player.play();
                                                }else if(data.currentLevelEasy == 6){
                                                  Navigator.of(context).pop();
                                                }
                                                data.levelLockEasy();
                                              },
                                              child: Image(image: AssetImage(shapesImagesList[data.currentLevelEasy]),width: 200)),
                                        ],
                                      ),
                                      Column(
                                        children: [
                                          ...
                                          InkWell(
                                              ...
                                              child: Image(image: AssetImage(shapesImagesList[imageIndexList![whichImage!]]),width: 200)),
                                        ],
                                      ),
                                    ],
                                  ),
