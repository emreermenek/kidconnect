...
class ProfessionChooseCorrectGameDifficulty extends StatefulWidget {
  ...
  @override
  State<ProfessionChooseCorrectGameDifficulty> createState() =>
      _ProfessionChooseCorrectGameDifficultyState();
}

class _ProfessionChooseCorrectGameDifficultyState
    extends State<ProfessionChooseCorrectGameDifficulty> {
  @override
              ...
              child: Container(
                decoration: const BoxDecoration(
                    image: DecorationImage(
                        image:
                            AssetImage('assets/images/difficulty/background.png'),
                        fit: BoxFit.fill)),
              ),
            ),
            const Align(
                        ...
                        children: [
                          ...
                          InkWell(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) =>
                                      const EasyProfessionsChooseCorrectGameLevelList(),
                                ));
                              },
                              child: const Image(
                                  image: AssetImage(
                          ...
                          InkWell(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) =>
                                      const HardProfessionChooseCorrectGameLevelList(),
                                ));
                              },
                              child: const Image(
                                  image: AssetImage(
