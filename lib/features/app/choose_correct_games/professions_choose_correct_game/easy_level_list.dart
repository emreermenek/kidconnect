...
class EasyProfessionsChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyProfessionsChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyProfessionsChooseCorrectGameLevelList> createState() => _EasyProfessionsChooseCorrectGameLevelListState();
}

class _EasyProfessionsChooseCorrectGameLevelListState extends ConsumerState<EasyProfessionsChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockEasy[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EasyProfessionChooseCorrectGame(),));
                      }else{
