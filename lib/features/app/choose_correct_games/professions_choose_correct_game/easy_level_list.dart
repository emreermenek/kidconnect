...
class EasyProfessionsChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EasyProfessionsChooseCorrectGameLevelList> createState() =>
      _EasyProfessionsChooseCorrectGameLevelListState();
}

class _EasyProfessionsChooseCorrectGameLevelListState
    extends ConsumerState<EasyProfessionsChooseCorrectGameLevelList> {
  List<String> levels = [
    'bölüm 1',
    'bölüm 2',
    'bölüm 3',
