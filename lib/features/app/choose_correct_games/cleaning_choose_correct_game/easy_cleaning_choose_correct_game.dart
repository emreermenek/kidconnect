...
class EasyCleaningChooseCorrectGame extends ConsumerStatefulWidget {
  const EasyCleaningChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyCleaningChooseCorrectGame> createState() =>
      _EasyCleaningChooseCorrectGameState();
}

class _EasyCleaningChooseCorrectGameState
    extends ConsumerState<EasyCleaningChooseCorrectGame> {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${cleaningNamesList[data.currentLevelEasy]}\n  bulalım', style: GoogleFonts.comfortaa(
                                      ...
                                      Column(
                                        children: [
                                          InkWell(
                                              ...
                                              child: Image(image: AssetImage(cleaningImagesList[data.currentLevelEasy]),width: 200)),
                                        ],
                                      ),
                                      Column(
                                        children: [
                                          ...
                                          InkWell(
                                              ...
                                              child: Image(image: AssetImage(cleaningImagesList[imageIndexList![whichImage!]]),width: 200)),
                                        ],
                                      ),
                                    ],
                                  ),
