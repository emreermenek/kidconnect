...
class HardCleaningChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const HardCleaningChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<HardCleaningChooseCorrectGameLevelList> createState() => _HardCleaningChooseCorrectGameLevelListState();
}

class _HardCleaningChooseCorrectGameLevelListState extends ConsumerState<HardCleaningChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockHard[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const HardCleaningChooseCorrectGame(),));
                      }else{
