...
class EasyCleaningChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<EasyCleaningChooseCorrectGameLevelList> createState() =>
      _EasyCleaningChooseCorrectGameLevelListState();
}

class _EasyCleaningChooseCorrectGameLevelListState
    extends ConsumerState<EasyCleaningChooseCorrectGameLevelList> {
  List<String> levels = [
    'bölüm 1',
    'bölüm 2',
    'bölüm 3',
                    ...
                    onTap: () {
                      if (data.lockEasy[index] ==
                        ...
                        Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              const EasyCleaningChooseCorrectGame(),
                        ));
                      } else {
