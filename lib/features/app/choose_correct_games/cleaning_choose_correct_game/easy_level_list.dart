...
class EasyCleaningChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const EasyCleaningChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyCleaningChooseCorrectGameLevelList> createState() => _EasyCleaningChooseCorrectGameLevelListState();
}

class _EasyCleaningChooseCorrectGameLevelListState extends ConsumerState<EasyCleaningChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockEasy[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const EasyCleaningChooseCorrectGame(),));
                      }else{
