...
class HardSeasonWeatherChooseCorrectGame extends ConsumerStatefulWidget {
  const HardSeasonWeatherChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<HardSeasonWeatherChooseCorrectGame> createState() =>
      _HardSeasonWeatherChooseCorrectGameState();
}

class _HardSeasonWeatherChooseCorrectGameState
    extends ConsumerState<HardSeasonWeatherChooseCorrectGame> {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${seasonWeatherNames[data.currentLevelHard]}\n   bulalım', style: GoogleFonts.comfortaa(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${data.currentLevelHard+1}/13',
                                            ...
                                            children: [
                                              InkWell(
                                                  onTap: (){
                                                    ...
                                                    _player.play();
                                                    if(data.currentLevelHard != 12){
                                                      setState(() {
                                                        data.currentLevelHard +=1;
                                                      });
                                                    }else if(data.currentLevelHard == 12){
                                                      Navigator.of(context).pop();
                                                    }
                                                    data.levelLockHard();
                                                  },
                                                  child: Image(image: AssetImage(seasonWeatherImages[data.currentLevelHard]),width: 120,)),
                                            ],
                                          ),
                                          Column(
                                            children: [
                                              ...
                                              InkWell(
                                                  ...
                                                  child: Image(image: AssetImage(seasonWeatherImages[imageIndexList![whichImage2!]]),width: 120,)),
                                            ],
                                          ),
                                        ],
                                      ),
