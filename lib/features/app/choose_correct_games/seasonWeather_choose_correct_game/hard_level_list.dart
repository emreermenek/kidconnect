...
import 'hard_season_weather_choose_correct_game.dart';
import 'services/services.dart';


class HardSeasonWeatherChooseCorrectGameLevelList extends ConsumerStatefulWidget {
  const HardSeasonWeatherChooseCorrectGameLevelList({Key? key}) : super(key: key);

  @override
  ConsumerState<HardSeasonWeatherChooseCorrectGameLevelList> createState() => _HardSeasonWeatherChooseCorrectGameLevelListState();
}

class _HardSeasonWeatherChooseCorrectGameLevelListState extends ConsumerState<HardSeasonWeatherChooseCorrectGameLevelList> {
  List<String> levels =
                  ...
                  return InkWell(
                    onTap: () {
                      if(data.lockHard[index] == 'assets/images/level_list/open_lock.png'){
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const HardSeasonWeatherChooseCorrectGame(),));
                      }else{
