...
class EasyThingsChooseCorrectGame extends ConsumerStatefulWidget {
  const EasyThingsChooseCorrectGame({Key? key}) : super(key: key);

  @override
  ConsumerState<EasyThingsChooseCorrectGame> createState() =>
      _EasyThingsChooseCorrectGameState();
}

class _EasyThingsChooseCorrectGameState
    extends ConsumerState<EasyThingsChooseCorrectGame> {
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${thingsNamesList[data.currentLevelEasy]}\n   bulalım', style: GoogleFonts.comfortaa(
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${data.currentLevelEasy+1}/30',
                                          ...
                                          InkWell(
                                              onTap: (){
                                                ...
                                                if(data.currentLevelEasy != 29){
                                                  ...
                                                  _player.play();
                                                }else if(data.currentLevelEasy == 29){
                                                  Navigator.of(context).pop();
                                                }
                                                data.levelLockEasy();
                                              },
                                              child: Image(image: AssetImage(thingsImagesList[data.currentLevelEasy]),width: 200)),
                                        ],
                                      ),
                                      Column(
                                        children: [
                                          ...
                                          InkWell(
                                              ...
                                              child: Image(image: AssetImage(thingsImagesList[imageIndexList![whichImage!]]),width: 200)),
                                        ],
                                      ),
                                    ],
                                  ),
