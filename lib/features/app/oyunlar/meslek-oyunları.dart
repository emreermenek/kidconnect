...
class MeslekOyunlariPage extends StatefulWidget {
  const MeslekOyunlariPage({Key? key}) : super(key: key);

  @override
  State<MeslekOyunlariPage> createState() => _MeslekOyunlariPageState();
}
...
class _MeslekOyunlariPageState extends State<MeslekOyunlariPage> {
  int _currentIndex = 0;
  @override
