...
class EsyaOyunlariPage extends StatefulWidget {
  const EsyaOyunlariPage({Key? key}) : super(key: key);

  @override
  State<EsyaOyunlariPage> createState() => _EsyaOyunlariPageState();
}
...
class _EsyaOyunlariPageState extends State<EsyaOyunlariPage> {
  int _currentIndex = 0;
  @override
